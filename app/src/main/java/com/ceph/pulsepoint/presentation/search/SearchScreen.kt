package com.ceph.pulsepoint.presentation.search
...
import com.ceph.pulsepoint.ui.theme.surfaceVariantLight
        ...
        SearchBar(
            ...
            trailingIcon = {
                IconButton(onClick = { if (searchQuery.isNotEmpty()) onQueryChange("") }) {
                    Icon(imageVector = Icons.Rounded.Clear, contentDescription = "Close")
